...
static void CreateAmbisonicsDRIRFile()
{
    ...
    /// fill the attributes as you want
    {
        ...
        attributes.Set( sofa::Attributes::kTitle,                   "Test AmbisonicsDRIR file" );
        attributes.Set( sofa::Attributes::kAuthorContact,           "andres.perez@eurecat.org" );
        attributes.Set( sofa::Attributes::kOrganization,            "Eurecat, Centre Tecnològic de Catalunya" );
        attributes.Set( sofa::Attributes::kApplicationName,         "createTestAmbisonicsDRIR.cpp" );
        ...
        attributes.Set( sofa::Attributes::kOrigin,                  "TODO" );
    ...
    const unsigned int numMeasurements  = 4;
    const unsigned int numReceivers     = 4;
    const unsigned int numEmitters      = 3;
    const unsigned int numDataSamples   = 480000;
    ...
    /// Data.SamplingRate
    {
        ...
        const double samplingRate = 96000;
